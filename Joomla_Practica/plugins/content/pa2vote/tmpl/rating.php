...
$rating = (int) (isset($row->rating) ? $row->rating : 0);
...
?>
<div class="content_rating" itemprop="aggregateRating" itemscope itemtype="https://schema.org/AggregateRating" data-option data-visibility="show_vote" data-visibility-value="<?php echo $params->get('show_vote'); ?>">
