					...
					<div class="form-horizontal">
						<div class="row-fluid show-grid">
							<div class="span12">
                                ...
                                <div class="control-group">
                                    <label class="control-label hasTip"
                                           title="<?php echo htmlspecialchars(JText::_('THEME_GRID_CAPTION_CSS_TITLE'));?>::<?php echo htmlspecialchars(JText::_('THEME_GRID_CAPTION_CSS_DESC')); ?>"><?php echo JText::_('THEME_GRID_CAPTION_CSS_TITLE'); ?>
                                    </label>
                                    <div class="controls">
                                        <textarea class="input-xlarge" name="caption_css" rows="5"><?php echo $items->caption_css; ?></textarea>
                                    </div>
                                </div>
                                ...
                                <div class="control-group">
                                    <label class="control-label hasTip"
                                           title="<?php echo htmlspecialchars(JText::_('THEME_GRID_DESCRIPTION_CSS_TITLE'));?>::<?php echo htmlspecialchars(JText::_('THEME_GRID_DESCRIPTION_CSS_DESC')); ?>"><?php echo JText::_('THEME_GRID_DESCRIPTION_CSS_TITLE'); ?>
                                    </label>
                                    <div class="controls">
                                        <textarea class="input-xlarge" name="description_css" rows="5"><?php echo $items->description_css; ?></textarea>
                                    </div>
                                </div>
							</div>
						</div>
