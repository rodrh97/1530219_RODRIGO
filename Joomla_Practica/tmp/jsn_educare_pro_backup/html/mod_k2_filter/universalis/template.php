...
<div id="K2FilterBox<?php echo $module->id; ?>" class="K2Filter_universalis K2FilterBlock<?php echo $params->get('moduleclass_sfx'); ?><?php if($cols == "0") echo ' k2filter-responsive'; ?>">
