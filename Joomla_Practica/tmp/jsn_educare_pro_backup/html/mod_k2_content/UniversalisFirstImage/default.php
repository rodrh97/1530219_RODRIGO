...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="UniversalisFirstImage k2ItemsBlock<?php if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?>">
		...
		<div class="content">
			...
			<?php if($params->get('itemTitle')): ?>
				<div class="title">
					...
					<?php if($params->get('itemDateCreated') && $i != 1) { ?>
			...
			<?php if(($i == 1) && ($params->get('itemIntroText') || $params->get('itemDateCreated'))): ?>
