...
<div id="k2Container" class="item-detail itemView<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?>">
	...
	<?php if($this->item->params->get('itemDateCreated') || $this->item->params->get('itemAuthor') || $this->item->params->get('itemHits')):?>
		<div class="info-head pull-right">
			...
			<?php if($this->item->params->get('itemHits')): ?>
				<!-- Item Hits -->
				<span class="itemHits"><i class="fa fa-eye" aria-hidden="true"></i><?php echo $this->item->hits; ?><?php echo JText::_('K2_TIMES'); ?></span>
			<?php endif; ?>
		</div>
	<?php endif;?>
	<div class="clr"></div>
	...
	<div class="itemBody">
		...
		<div class="itemExtraFields">
			...
			<div class="row">
				...
				<div class="col-xs-12 col-sm-4 <?php echo ($key%2) ? "odd" : "even"; ?> type<?php echo ucfirst($extraField->type); ?> group<?php echo $extraField->group; ?>">
	...
	<?php if(($this->item->params->get('itemTwitterButton',1) || $this->item->params->get('itemFacebookButton',1) || $this->item->params->get('itemGooglePlusOneButton',1)) || ($this->item->params->get('itemTags') && count($this->item->tags)) ): ?>
	...
	*/
	...
	<div class="itemRelated">
		...
		<div class="row">
			...
			<div class="col-sm-4 <?php echo ($key%2) ? "odd" : "even"; ?>">
				<div class="item">
