...
<div id="k2ModuleBox<?php echo $module->id; ?>" class="UniversalisEventNews k2ItemsBlock<?php if($params->get('moduleclass_sfx')) echo ' '.$params->get('moduleclass_sfx'); ?>">
  ...
  <div class="row">
    <?php foreach ($items as $key=>$item):	?>
    	<div class="col-sm-4 <?php echo ($key%2) ? "odd" : "even"; if(count($items)==$key+1) echo ' lastItem'; ?>">
			<div class="item">
			  ...
			  <?php echo $item->event->K2BeforeDisplay; ?>
				...
				<?php if(($params->get('itemImage') && isset($item->image)) || ($params->get('itemTags') && count($item->tags)>0)): ?>
					<div class="media">
			  ...
			  <?php if($params->get('itemDateCreated')): ?>
			  	<span class="moduleItemDateCreated">
					<i class="fa fa-calendar" aria-hidden="true"></i><?php echo JHTML::_('date', $item->created, 'd M Y'); ?>
				</span>
			  <?php endif; ?>
